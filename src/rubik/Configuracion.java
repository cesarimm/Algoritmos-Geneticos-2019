...
public class Configuracion {
   ...
   private String id;
    ...
    public Configuracion(String id, int numGeneraciones, int tamPoblacion, double probMuta, double pMuestra, Seleccion.TipoSeleccion[] tipoSeleccion, int tamGenotipo, int[] scramble) {
    ...
    public Configuracion(int numGeneraciones, int tamPoblacion, double probMuta, double pMuestra, Seleccion.TipoSeleccion[] tipoSeleccion, int tamGenotipo, int[] scramble) {
        this.numGeneraciones = numGeneraciones;
        this.tamPoblacion = tamPoblacion;
        this.probMuta = probMuta;
        this.pMuestra = pMuestra;
   ...
   public Configuracion(int tamGenotipo) {
        ...
        this.tamGenotipo = tamGenotipo;
        this.scramble = new int[]{3,3,9,9,2,7,7,4,11,11,8,8,5,5,2,11,6,6,1,7,12,10,2,2,7,3,11,11,2,2};
        id="";
    }
   
   
   public Cubo aplicarSeleccion(Poblacion pobActual, int i){
       Cubo aux = null; 
       // evaluar i
